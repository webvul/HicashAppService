...
import com.hengyuan.hicash.domain.event.user.NewCollarApp3UpdateEvent;
 ...
 *
 */
public class NewCollarApp3UpdateService implements RespService {
	
	private static Logger logger = Logger.getLogger(NewCollarApp3UpdateService.class);

	private NewCollarApp3UpdateEvent collarUpdateMsgEvent = new NewCollarApp3UpdateEvent();

	@Override
	public ParmResponse responseValue(ParmRequest parmRequest) {

		NewCollarApp3UpdateReq collarUpdateMsgReq = (NewCollarApp3UpdateReq) parmRequest;
