...
import com.hengyuan.hicash.domain.event.user.NewStuApp2UpdateEvent;
 ...
 *
 */
public class NewStuApp2UpdateService  implements RespService{

	private static Logger logger = Logger.getLogger(NewStuApp2UpdateService.class);

	private NewStuApp2UpdateEvent schoolMsgEvent = new NewStuApp2UpdateEvent();
	...
	public ParmResponse responseValue(ParmRequest parmRequest) {
		...
		NewStuApp2UpdateReq updateMsgReq = (NewStuApp2UpdateReq) parmRequest;
