...
import com.hengyuan.hicash.domain.event.user.NewCollarApp2UpdateEvent;
 ...
 *
 */
public class NewCollarApp2UpdateService implements RespService {
	
	private static Logger logger = Logger.getLogger(NewCollarApp2UpdateService.class);

	private NewCollarApp2UpdateEvent collarUpdateMsgEvent = new NewCollarApp2UpdateEvent();

	@Override
	public ParmResponse responseValue(ParmRequest parmRequest) {

		NewCollarApp2UpdateReq collarUpdateMsgReq = (NewCollarApp2UpdateReq) parmRequest;
