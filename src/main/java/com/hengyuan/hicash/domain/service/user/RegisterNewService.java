...
import com.hengyuan.hicash.domain.service.amount.CreDreamAmtNewService;
...
public class RegisterNewService implements RespService{
	...
	private void setAmount(RegisterReq registerReq) throws UpdatePageIndexException, SQLException{
		...
		CreDreamAmtNewService service = new CreDreamAmtNewService();
...
//			customerEvent.updateRegistInfo(registerReq);
	 ...
	 * @createDate 2015-04-21
	 */
	private void registerUserNew(RegisterReq registerReq) throws SaveCustUserException, SaveAuthorityException, SaveCustomerException, SaveAccountException {
		...
		CustomerEvent customerEvent = new CustomerEvent();
		customerEvent.createCustomerNew(registerReq);
