...
public class CreateCreditEvent {
	private static Logger logger = Logger.getLogger(CreateCreditEvent.class);
	/**
	 * 根据SQL语句更新申请件
	 * 
	 * @param updateSql
	...
	public void CreateCredit(Map<String, Object> creditMap)
		...
		String createSql = MapAssemForSql.getInsertSql(TableConsts.DDSJ_APPLY_CREDIT,creditMap);
	...
	public void createDdsjLimit(Map<String, Object> ddsjLimitMap)
			throws CreateDdsjLimitException {

		String createSql = MapAssemForSql.getInsertSql(TableConsts.DDSJ_LIMIT,ddsjLimitMap);
		RecordUtils.writeAction(logger, null, createSql);
		if (ConnManager.executeUpdate(createSql) <= 0) {
	...
	public void updateDdsjLimit(String username,String status,String sxMobile,String password)
			throws CreateDdsjLimitException {

		String sql="UPDATE ddsj_limit set status='"+status+"' , sx_mobile = '"+sxMobile+"' , sx_mobile_password = '"+password+"' "+
	...
	public void updateTempCredit(String tempAppNo,String appNo) throws UpdateTempAppException{
		String sql="UPDATE ddsj_tempapply_credit set app_application_no='"+appNo+"' ,createapp_flag='Y' " +
	...
	public void updateCreateCredit(String appNo) throws UpdateCreateCreditException{
		String sql="UPDATE ddsj_apply_credit set status='STATUS20',node='GBNODE'  " +
	 ...
	 * @throws UpdateCreateCreditException
	 */
	public void updateDdsjLimitSta(String userName) throws UpdateDdsjLimitException{
		String sql="UPDATE ddsj_limit set status='NOML' " +
				" where username='"+userName+"'";
		RecordUtils.writeAction(logger, null, sql);
		if (ConnManager.executeUpdate(sql) <= 0) {
