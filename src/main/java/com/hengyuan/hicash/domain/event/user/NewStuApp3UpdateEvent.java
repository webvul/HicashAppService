 ...
 *
 */
public class NewStuApp3UpdateEvent {
	private static Logger logger = Logger.getLogger(NewStuApp3UpdateEvent.class);
	 ...
	 */
	public void updateStuApp1(NewStuApp3UpdateReq updateMsgReq) 
			throws SaveInfoException {
