...
import com.hengyuan.hicash.domain.service.user.RegisterNewService;
...
import com.hengyuan.hicash.service.validate.update.RegisterValNew;
...
public class RegisterNew extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		/* 实例化参数验证 */
		RegisterValNew registerVal = new RegisterValNew(registerReq);
		...
		if (!ResultCodes.NORMAL.equals(resultCode)) {
			...
			RegisterNewService registerService = new RegisterNewService();
