...
import com.hengyuan.hicash.domain.service.user.SaveAppAccountService;
 ...
 *
 */
@WebServlet("/SaveAppAccount")
public class SaveAppAccount extends HttpServlet {

	private static Logger logger = Logger.getLogger(SaveAppAccount.class);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if(!ResultCodes.NORMAL.equals(resultCode)){
			...
			SaveAppAccountService acctService = new SaveAppAccountService();
