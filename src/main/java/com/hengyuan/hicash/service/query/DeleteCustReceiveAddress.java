...
import com.hengyuan.hicash.domain.service.user.UpdateAddressStatusService;
 ...
 *
 */
@WebServlet("/DeleteCustReceiveAddress")
public class DeleteCustReceiveAddress extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if(!ResultCodes.NORMAL.equals(resultCode)){
			...
			UpdateAddressStatusService  service = new UpdateAddressStatusService();
