...
* 类说明 :临时订单状态查询
 */
@WebServlet("/CreditAuthInfoQuery")
public class CreditAuthInfoQuery extends HttpServlet {
	
	private static Logger logger = Logger.getLogger(CreditAuthInfoQuery.class);
