...
import com.hengyuan.hicash.domain.service.user.NewCollarApp1MsgService;
 ...
 *
 */
@WebServlet("/NewCollarApp1Msg")
public class NewCollarApp1Msg extends HttpServlet {

	private static final long serialVersionUID = -8485963175175699076L;
	private static Logger logger = Logger.getLogger(NewCollarApp1Msg.class);	
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if (!ResultCodes.NORMAL.equals(result)) {
			...
			NewCollarApp1MsgService  collarQueryService = new NewCollarApp1MsgService();
			
			NewCollarApp1MsgResp valresp = (NewCollarApp1MsgResp) collarQueryService.responseValue(queryMsgReq);
