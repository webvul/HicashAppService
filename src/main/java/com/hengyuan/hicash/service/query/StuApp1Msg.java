...
import com.hengyuan.hicash.domain.service.user.StuApp1Service;
 ...
 *
 */
@WebServlet("/StuApp1Msg")
public class StuApp1Msg extends HttpServlet {

	private static final long serialVersionUID = -4030614367830870998L;
	private static Logger logger = Logger.getLogger(StuApp1Msg.class);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if (!ResultCodes.NORMAL.equals(restult)) {
			StuApp1Resp stuApp1Resp = new StuApp1Resp();
			...
			StuApp1Service  stuMsgService = new StuApp1Service();
			StuApp1Resp valresp = (StuApp1Resp) stuMsgService.responseValue(queryMsgReq);
