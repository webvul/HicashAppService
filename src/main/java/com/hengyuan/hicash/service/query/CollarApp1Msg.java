 ...
 *
 */
@WebServlet("/CollarApp1Msg")
public class CollarApp1Msg extends HttpServlet {

	private static final long serialVersionUID = -8485963175175699076L;
	private static Logger logger = Logger.getLogger(CollarApp1Msg.class);	
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if (!ResultCodes.NORMAL.equals(result)) {
			CollarApp1MsgResp valresp = new CollarApp1MsgResp();
			...
			CollarApp1MsgService  collarQueryService = new CollarApp1MsgService();
			
			CollarApp1MsgResp valresp = (CollarApp1MsgResp) collarQueryService.responseValue(queryMsgReq);
