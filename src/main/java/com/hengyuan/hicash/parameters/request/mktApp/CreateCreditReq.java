 ...
 * 类说明 :正式订单请求参数
 */
public class CreateCreditReq extends RequestSequence{
	...
	private String fulltimeDriver;//是否全职司机
	...
	private String ddsj_auth_result;//是否已有司机贷报告
	private String credit_type;//类型（授信，提额）
	private String yys_phone_result;//是否已有运营商报告
	...
	public String getDdsj_auth_result() {
		return ddsj_auth_result;
	}
	public void setDdsj_auth_result(String ddsj_auth_result) {
		this.ddsj_auth_result = ddsj_auth_result;
	}
	...
	public String getYys_phone_result() {
		return yys_phone_result;
	}
	public void setYys_phone_result(String yys_phone_result) {
		this.yys_phone_result = yys_phone_result;
	}
